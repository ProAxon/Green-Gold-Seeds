                ...
                <div className="main-menu-two__top-inner">
                  ...
                  <div className="main-menu-two__top-right">
                    ...
                    <div className="main-menu-two__social">
                      <a href="/blog#"><i className="fab fa-twitter" /></a>
                      <a href="/blog#"><i className="fab fa-facebook-f" /></a>
                      <a href="/blog#"><i className="fab fa-pinterest-p" /></a>
                      <a href="/blog#"><i className="fab fa-instagram" /></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mobile-nav__content">
            ...
            <div className="mobile-nav__top">
              <div className="mobile-nav__social">
                <a href="/blog#" className="fab fa-twitter" />
                <a href="/blog#" className="fab fa-facebook-square" />
                <a href="/blog#" className="fab fa-pinterest-p" />
                <a href="/blog#" className="fab fa-instagram" />
