    ...
    <>
      ...
      <div>
        ...
        <div className="page-wrapper">
                ...
                <div className="main-menu-two__top-inner">
                  ...
                  <div className="main-menu-two__top-right">
                    ...
                    <div className="main-menu-two__social">
                      ...
                      <a href="https://www.facebook.com/GreenGoldSeedsAurangabad" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook" /></a>
                  ...
                  <div className="main-menu-two__wrapper-inner">
                    ...
                    <div className="main-menu-two__main-menu-box">
                      ...
                      <ul className="main-menu__list">
                        ...
                        */}
                        <li className="dropdown">
                          <a href="/about#" onClick={(e) => e.preventDefault()}>{t('nav.products')}</a>
                          <ul className="shadow-box">
          ...
          {/*Author One End */}
          {/*Infrastructure Highlights Start */}
